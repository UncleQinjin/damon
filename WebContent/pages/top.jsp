...
<body style="background:url(${webContent}images/topbg.gif) repeat-x;">
		<div class="topleft">
			<a href="${webContent}pages/main.jsp" target="_parent"></a>
		</div>
		<div class="topright">
			<ul>
				<li><span><img src="${webContent}images/help.png" title="帮助"  class="helpimg"/></span>
					<a href="#">帮助</a>
				</li>
				<li>
					<a href="#">关于</a>
				...
				<li>
					<a href="${webContent}login.jsp" target="_parent">退出</a>
				</li>
			</ul>
			<div class="user">
